...
function Validate-Environment {
    ...
    if (-not (Test-Path $TEMPLATE_FILE)) {
        ...
        Write-Info 'Proceeding without template: existing agent files will be updated; new agent files will be skipped.'
    }
}
...
function New-AgentFile {
    ...
    if (-not (Test-Path $TEMPLATE_FILE)) { Write-WarningMsg "Template not found at $TEMPLATE_FILE. Skipping new agent file creation."; return $false }
...
function Update-AgentFile {
    ...
    if (-not (Test-Path $TargetFile)) {
        if (Test-Path $TEMPLATE_FILE) {
            ...
            Write-WarningMsg "Template missing; skipping creation of $AgentName context file: $TargetFile"
            return $true
        }
    } else {
        try {
